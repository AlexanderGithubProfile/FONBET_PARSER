...
## Использование 
Приложение запускается в контейнере c работой без открытия окна, включение исполняемым файлом для удобной работы без IDE (pycharm) и авто-запуском Docker
> - скрипт имитирует поведение пользователя, скроллит страницу и собирает необходимые данные
> - управление запуском и остановкой из чата, расчет ставок и их выставление на основе собранных данных
> - автоматизации входа через подгрузка данных входа с куки
> - команды screen/ stat - скриншот текущего экрана/ визуализация статистики по счету отправляются в чат
